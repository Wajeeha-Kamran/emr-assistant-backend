    ...
    def _clean():
        ...
        try:
            test_emails = [
                ...
                "test_codesug@example.com",
                "test_codesug_api@example.com",
                "test_codesug_api_other@example.com",
                "doc_edit_api@example.com",
                "doc_edit_api_other@example.com",
                "doc_sign_api@example.com",
                "doc_sign_api_other@example.com"
            ]
            ...
            if doctor_ids:
                ...
                if session_ids:
                    ...
                    db.query(CodeSuggestion).filter(
                        CodeSuggestion.soap_note_id.in_(
                            db.query(SOAPNote.id).filter(
                                SOAPNote.session_id.in_(session_ids)
                            )
                        )
